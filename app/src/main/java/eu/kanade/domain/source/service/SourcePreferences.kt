...
class SourcePreferences(
    ...
    val extensionRepos: Preference<Set<String>> = preferenceStore.getStringSet("extension_repos", setOf("https://raw.githubusercontent.com/keiyoushi/extensions/repo/index.min.json"))
